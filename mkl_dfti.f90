...
! delivery
! of the Materials,  either expressly, by implication, inducement,
! estoppel or
...
MODULE MKL_DFT_TYPE
  ...
  ! INTEGER, PARAMETER :: DFTI_INITIALIZATION_EFFORT = 16 ! NOT
  ! IMPLEMENTED
...
MODULE MKL_DFTI
  ...
  INTERFACE DftiErrorMessage
     ...
     FUNCTION dfti_error_message_external(Status)
       ...
       !MS$ATTRIBUTES REFERENCE :: Status
       CHARACTER(LEN=DFTI_MAX_MESSAGE_LENGTH) ::      Cdfti_error_message_external
       INTEGER, INTENT(IN) :: Status
